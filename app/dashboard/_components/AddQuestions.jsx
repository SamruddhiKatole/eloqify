...
// // //           setResumeText(text.text); // Extracted text
// // //         };
...
// // //     try {
// // //       const result = await chatSession.sendMessage(InputPrompt);
// // //       const MockQuestionJsonResp = result.response.text()
// // //         .replace("```json", "")
// // //         .replace("```", "")
// // //         .trim();
...
// // //             <form onSubmit={onSubmit}>
// // //               <div className="my-3">
// // //                 <label className="text-black">Job Position</label>
// // //                 <Input value={jobPosition} placeholder="Ex. Full Stack Developer" required onChange={handleInputChange(setJobPosition)} />
// // //               </div>

// // //               <div className="my-3">
// // //                 <label className="text-black">Job Description / Tech Stack</label>
// // //                 <Textarea value={jobDesc} placeholder="Ex. React, Node.js, MySQL" required onChange={handleInputChange(setJobDesc)} />
// // //               </div>

// // //               <div className="my-3">
// // //                 <label className="text-black">Type of Questions</label>
// // //                 <Input value={typeQuestion} placeholder="Ex. DSA, System Design" required onChange={handleInputChange(setTypeQuestion)} />
// // //               </div>

// // //               <div className="my-3">
// // //                 <label className="text-black">Company</label>
// // //                 <Input value={company} placeholder="Ex. Google, Microsoft" required onChange={handleInputChange(setCompany)} />
// // //               </div>

// // //               <div className="my-3">
// // //                 <label className="text-black">Years of Experience</label>
// // //                 <Input type="number" value={jobExperience} placeholder="Ex. 3" required onChange={handleInputChange(setJobExperience)} />
// // //               </div>

// // //               <div className="my-3">
// // //                 <label className="text-black">Upload Resume</label>
// // //                 <Input type="file" accept=".pdf,.txt" onChange={handleFileUpload} />
// // //                 {resumeText && <p className="mt-2 text-sm text-gray-600">Resume uploaded successfully!</p>}
// // //               </div>

// // //               <div className="flex gap-5 justify-end">
// // //                 <Button type="button" variant="ghost" onClick={() => setOpenDialog(false)}>Cancel</Button>
// // //                 <Button type="submit" disabled={loading}>
// // //                   {loading ? <LoaderCircle className="animate-spin" /> : "Prep. Questions"}
// // //                 </Button>
// // //               </div>
// // //             </form>
// // //           </DialogHeader>
